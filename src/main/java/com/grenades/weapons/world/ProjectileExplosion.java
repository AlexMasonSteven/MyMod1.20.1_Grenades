package com.grenades.weapons.world;
...
public class ProjectileExplosion extends Explosion
{
    ...
    public ProjectileExplosion(Level world, Entity exploder, @Nullable DamageSource source, @Nullable ExplosionDamageCalculator context, int x, int y, int z, float size, boolean causesFire, BlockInteraction mode)
    {
